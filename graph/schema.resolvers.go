...
func (r *categoryResolver) Courses(ctx context.Context, obj *model.Category) ([]*model.Course, error) {
	...
	coursesModel := make([]*model.Course, len(courses), cap(courses))
	for index, course := range courses {
		coursesModel[index] = &model.Course{ID: course.ID, Name: course.Name, Description: &course.Description}
	}
...
func (r *queryResolver) Categories(ctx context.Context) ([]*model.Category, error) {
	...
	categoriesModel := make([]*model.Category, len(categories), cap(categories))
	for index, category := range categories {
		categoriesModel[index] = &model.Category{ID: category.ID, Name: category.Name, Description: &category.Description}
	}
